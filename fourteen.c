...
int main() {
    ...
    for (int i = 0; i < oscSystem.numOscillators; ++i) {
        ...
        if (i == 0) {
          oscSystem.oscillators[i].amplitude = 1;
          oscSystem.oscillators[i].baseFrequency = .5;
          oscSystem.oscillators[i].waveformType = WAVEFORM_SAWTOOTH;
          oscSystem.oscillators[i].enableAmpEnvelope = 0;
          oscSystem.oscillators[i].enableFreqEnvelope = 0;
        } else if (i == 1) {
          oscSystem.oscillators[i].baseFrequency = 5;
          oscSystem.oscillators[i].waveformType = WAVEFORM_SINE;
        } else {
          oscSystem.oscillators[i].ampAttack = 2;
          oscSystem.oscillators[i].ampAttack = 1;
          oscSystem.oscillators[i].ampSustain = 3;
          oscSystem.oscillators[i].ampRelease = 5;
        }
    }
    ...
    oscSystem.oscillators[1].isLFO = 1;
    //oscSystem.oscillators[2].ampLfoIndex = 1;
    oscSystem.oscillators[2].freqLfoIndex = 0;
